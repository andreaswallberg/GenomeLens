...
export async function all_buttons(container) {
    ...
    canvas0.addEventListener('click', function () {
        ...
        window.canvas_num = 0;
        canvas_number.innerHTML = 'Annotation canvas';
        current_canvas.innerHTML = 'Current Canvas Annotation';
...
export function addOrUpdateCanvasObject(canvasId) {
    ...
    const newCanvasObject = {
        ...
        style: {
            background: "#fbfbfb",
            backgroundOpacity: 0, // Set opacity to 0 for transparent background (otherwise data is not visible after new track is loaded)
			outlineWidth: 5,
			outline: "#e7e7e7",
        },
        tracks: [
